...
package com.hahn.logic;

import com.hahn.bo.SkuOrderBO;
import com.hahn.core.enumeration.CouponType;
import com.hahn.core.money.IMoneyDiscount;
    ...
    public void finalTotalPriceIsOk(List<SkuOrderBO> skuOrderBOList, BigDecimal orderFinalTotalPrice,
        ...
        switch (CouponType.toType(this.coupon.getType())) {
            ...
            case FULL_OFF:
                ...
                BigDecimal ratePrice = this.iMoneyDiscount.discount(orderCategoryPrice,  new BigDecimal(1).subtract(this.coupon.getRate()));
                serverFinalTotalPrice = serverTotalPrice.subtract(ratePrice);
                break;
            default:
